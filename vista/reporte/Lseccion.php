    ...
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center"> 
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Listado de Secciones</li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-block">
                   <form action="<?php echo constant('URL'); ?>reporte/Reporte_ListadoS" enctype="multipart/form-data" id="formulario" method="POST" name="formulario">
                        <div class="card-block">
                            <div class="form-group row justify-content-center">
                                <div class="card">
                                    <h1 class="text-themecolor">
                                        Reporte Listado de Secciones
                                    </h1>
                                </div>
                                ...
                                <div class="col-9">
                                    ...
                                    <?php include modal."reporte-listado-seccion.php"; ?> 
                                </div>
