    ...
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center"> 
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Aulario</li>
                        ...
                        <div class="card-block">
                            <div class="form-group row justify-content-center">
                                ...
                                <div class="col-12 ">
                                    ...
                                    <select class="custom-select form-control" id="aula" name="aula">
                            ...
                            <div class="form-group text-center m-t-20">
                                ...
                                <input type="button" class="btn  btn-info m-r-10" name="completo" id="completo" value="Listado Completo"aria-hidden="true" data-placement="bottom" data-target="#reporte" data-toggle="modal">
