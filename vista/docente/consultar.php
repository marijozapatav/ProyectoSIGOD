                                    ...
                                    <tbody id="normal-consult"> 
                                        <?php foreach ($this->docentes as $profesores) { ?>
                                             <tr>
                                                ...
                                                <a title="Eliminar usuario" onmouseover="this.style.color='#A60303'" onmouseout="this.style.color='red'" class="mdi mdi-delete" style="font-size: 30px; color: red; " type="button" href="<?php echo constant('URL'); ?>docente/Eliminar/<?php echo $profesores["cedula"];?>"></a>
                                            </td> 
                                             </tr>
                                    <?php    } ?>
